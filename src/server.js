...
app.get('/api/randomrepo', function(req, res, next) {
    ...
    db.connect();
      ...
      db.query("SELECT * FROM details_repos AS r1 JOIN (SELECT (RAND() * (SELECT MAX(id) FROM details_repos)) AS id) AS r2 WHERE r1.id >= r2.id ORDER BY r1.id ASC LIMIT 1", function (error, results, fields) {
